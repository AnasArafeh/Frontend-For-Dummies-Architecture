...
| **State Management** (Section service) | [`state-management/dashboard-overview/`](./src/app/(modules)/device-dashboard/state-management/dashboard-overview/) | RxJS `BehaviorSubject`. At module level — imported by both Page and Section. |
