...
import './cart-actions.segment.scss';
...
export function CartActionsSegment() {
  ...
  const cartBtnClass = `cart-actions-add-to-cart${addedToCart ? ' cart-actions-add-to-cart-added' : ''}`;

  return (
    <BaseBox className="cart-actions">
      <BaseButton
      ...
      <BaseButton
        ...
        className="cart-actions-buy-now"
      >
        Buy Now
      </BaseButton>
    </BaseBox>
