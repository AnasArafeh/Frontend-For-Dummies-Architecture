...
import './product-purchase.area.scss';
...
export function ProductPurchaseArea() {
  ...
  return (
    <BaseBox>
      <BaseCard className="product-purchase">
        <PriceSummarySegment />
        <BaseBox
          component="hr"
          className="product-purchase-divider"
        />
        <DeliveryInfoSegment />
        <BaseBox
          component="hr"
        ...
        {sellerInfo && (
          <BaseBox className="product-purchase-seller-info">
            <BaseBox
              component="p"
              className="product-purchase-seller-heading"
            >
              Shipper / Seller
            </BaseBox>
        ...
        <BaseBox
          component="a"
          href="#"
          className="product-purchase-add-to-list"
        >
          Add to List
        </BaseBox>
      </BaseCard>
