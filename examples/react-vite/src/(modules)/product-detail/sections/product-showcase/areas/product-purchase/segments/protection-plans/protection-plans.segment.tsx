...
import './protection-plans.segment.scss';
...
export function ProtectionPlansSegment() {
  ...
  const renderPlan = (plan: ProtectionPlan) => (
    <BaseBox
      key={plan.id}
      className="protection-plans-row"
    >
      <BaseBox
        component="input"
        type="checkbox"
        ...
        className="protection-plans-checkbox"
        id={plan.id}
      />
      <BaseBox
        component="label"
        htmlFor={plan.id}
        className="protection-plans-label"
      >
  ...
  return (
    <BaseBox>
      <BaseBox
        component="h4"
        className="protection-plans-heading"
      >
