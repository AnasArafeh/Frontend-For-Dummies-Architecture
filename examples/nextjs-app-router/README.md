...
| **State Management** | [`state-management/dashboard-overview/`](./src/app/(modules)/device-dashboard/state-management/dashboard-overview/) | At module level — imported by both Page and Section |
